...
// Componente reutilizable de chips removibles + buscador "+ Agregar" --
// Paso 2 del wizard de Residuos (Corrientes Y/A/Códigos UN, Figma nodeId
// 606:5341). Se prueba en aislamiento (sin depender de la API) porque se
// reutiliza 3 veces dentro de WasteWizard.
